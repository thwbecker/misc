...
/* 
   ...
   show the back-azimuthal dependence of the fast azimuth and delay
   time for a given two layer anisotropy model
...
int main(int argc, char **argv)
{
  ...
  fprintf(stderr,"%s: working on 1: %g,%g 2: %g,%g at period %g\n",argv[0],fazi[0],dt[0],fazi[1],dt[1],period);
  for(bazi=0;bazi<360;bazi+=0.5){
