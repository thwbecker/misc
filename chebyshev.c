...
/*
  ...
  evaluate normalized 
  Chebyshev polynomials at a <= x <= b 
...
/*
  ...
  calculates derivatives of Chebyshev expansion c[0...n-1]

 */
void chder(COMP_PRECISION a,COMP_PRECISION b,
	   COMP_PRECISION *c,COMP_PRECISION *cder,
	   int n)
{
  int j;
  COMP_PRECISION con;
...
/*
  ...
  sqrt(\int_{x=-1}^{x=1} (d_x T_n(x))^2 dx)

*/

COMP_PRECISION chebev_der_int(COMP_PRECISION x1,COMP_PRECISION x2,int i)
{
  static COMP_PRECISION f[101]={0., 1.41421, 3.26599, 5.25357, 7.3238, 9.45331, 11.6289, 
